...
type Todo struct {
	...
	Hito      string    `boil:"hito" json:"hito" toml:"hito" yaml:"hito"`
...
var (
	todoAllColumns            = []string{"id", "hito", "content", "status", "created_at", "update_at"}
	todoColumnsWithoutDefault = []string{"hito", "content", "status", "created_at", "update_at"}
